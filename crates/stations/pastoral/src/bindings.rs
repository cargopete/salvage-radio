        ...
        pub mod host_cache {
            ...
            pub fn get(key: &str) -> Option<_rt::Vec<u8>> {
                unsafe {
                    ...
                    #[link(wasm_import_module = "radio:station/host-cache@0.1.0")]
                    unsafe extern "C" {
                        #[link_name = "get"]
    ...
    pub mod radio {
        pub mod station {
            ...
            pub mod station {
                ...
                #[derive(Clone)]
                pub struct Metadata {
                    pub callsign: _rt::String,
                    /// "BG-POL", "PASTORAL-1" — short ID
                    pub name: _rt::String,
                    /// "Bulgarian Politics"
                    pub description: _rt::String,
                    /// one paragraph, plain text
                    pub frequency: _rt::String,
                    /// "92.4" — aesthetic only, shown on dial
                    pub operator: _rt::String,
                    /// curator / author name
                    pub cadence_seconds: u32,
                    /// hint: how often the host should call tune()
                    pub declared_hosts: _rt::Vec<_rt::String>,
                }
                impl ::core::fmt::Debug for Metadata {
                    fn fmt(
                        ...
                        f.debug_struct("Metadata")
                            ...
                            .field("cadence-seconds", &self.cadence_seconds)
                            .field("declared-hosts", &self.declared_hosts)
                            .finish()
                    }
                }
                ...
                pub struct Broadcast {
                    pub id: _rt::String,
                    /// stable, opaque, station-chosen; host uses for dedup
                    pub title: _rt::String,
                    pub body: _rt::String,
                    /// plain text or simple markdown — never HTML
                    pub source: _rt::String,
                    /// human-readable origin ("BBC", "Hacker News")
                    pub permalink: _rt::String,
                    /// URL the user can open externally
                    pub published: u64,
                    /// unix seconds; 0 means unknown
                    pub tags: _rt::Vec<_rt::String>,
                }
                impl ::core::fmt::Debug for Broadcast {
                    fn fmt(
                        &self,
                        f: &mut ::core::fmt::Formatter<'_>,
                    ) -> ::core::fmt::Result {
                ...
                pub enum Signal {
                    OnAir(Broadcast),
                    /// a fresh broadcast is ready
                    Static,
                    /// nothing new; station is quiet but healthy
                    OffAir(_rt::String),
                }
                impl ::core::fmt::Debug for Signal {
                    fn fmt(
                        ...
                        match self {
                            Signal::OnAir(e) => {
                                f.debug_tuple("Signal::OnAir").field(e).finish()
                            }
                            Signal::Static => f.debug_tuple("Signal::Static").finish(),
                            Signal::OffAir(e) => {
                                f.debug_tuple("Signal::OffAir").field(e).finish()
                            }
                        }
                    }
                }
                ...
                pub unsafe fn _export_describe_cabi<T: Guest>() -> *mut u8 {
                    ...
                    let Metadata {
                        ...
                        operator: operator2,
                        cadence_seconds: cadence_seconds2,
                        declared_hosts: declared_hosts2,
                    } = result0;
                    let vec3 = (callsign2.into_bytes()).into_boxed_slice();
                    ...
                    *ptr1
                    ...
                    let vec6 = (frequency2.into_bytes()).into_boxed_slice();
                    let ptr6 = vec6.as_ptr().cast::<u8>();
                    let len6 = vec6.len();
                    ...
                    *ptr1
                    ...
                    let vec7 = (operator2.into_bytes()).into_boxed_slice();
                    ...
                    *ptr1.add(10 * ::core::mem::size_of::<*const u8>()).cast::<i32>() = _rt::as_i32(
                        cadence_seconds2,
                    );
                    let vec9 = declared_hosts2;
                    let len9 = vec9.len();
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_tune_cabi<T: Guest>() -> *mut u8 {
                    #[cfg(target_arch = "wasm32")] _rt::run_ctors_once();
                    let result0 = T::tune();
                    let ptr1 = (&raw mut _RET_AREA.0).cast::<u8>();
                    match result0 {
                        Signal::OnAir(e) => {
                            ...
                            *ptr1
                                ...
                                .cast::<*mut u8>() = ptr4.cast_mut();
                            let vec5 = (body2.into_bytes()).into_boxed_slice();
                            let ptr5 = vec5.as_ptr().cast::<u8>();
                            let len5 = vec5.len();
                            ::core::mem::forget(vec5);
                            *ptr1
                            ...
                            *ptr1
                                ...
                                .cast::<*mut u8>() = ptr5.cast_mut();
                            let vec6 = (source2.into_bytes()).into_boxed_slice();
                            let ptr6 = vec6.as_ptr().cast::<u8>();
                            let len6 = vec6.len();
                            ::core::mem::forget(vec6);
                            *ptr1
                            ...
                            *ptr1
                                ...
                                .cast::<*mut u8>() = ptr6.cast_mut();
                            let vec7 = (permalink2.into_bytes()).into_boxed_slice();
                            let ptr7 = vec7.as_ptr().cast::<u8>();
                            let len7 = vec7.len();
                            ::core::mem::forget(vec7);
                            *ptr1
                            ...
                            *ptr1
                                ...
                                .cast::<i64>() = _rt::as_i64(published2);
                            let vec9 = tags2;
                            let len9 = vec9.len();
                            let layout9 = _rt::alloc::Layout::from_size_align_unchecked(
                                vec9.len() * (2 * ::core::mem::size_of::<*const u8>()),
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn __post_return_tune<T: Guest>(arg0: *mut u8) {
                ...
                #[doc(hidden)]
                macro_rules! __export_radio_station_station_0_1_0_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[unsafe (export_name =
                        "radio:station/station@0.1.0#describe")] unsafe extern "C" fn
                        export_describe() -> * mut u8 { unsafe { $($path_to_types)*::
                        _export_describe_cabi::<$ty > () } } #[unsafe (export_name =
                        "cabi_post_radio:station/station@0.1.0#describe")] unsafe extern
                        "C" fn _post_return_describe(arg0 : * mut u8,) { unsafe {
                        $($path_to_types)*:: __post_return_describe::<$ty > (arg0) } }
                        #[unsafe (export_name = "radio:station/station@0.1.0#tune")]
                        unsafe extern "C" fn export_tune() -> * mut u8 { unsafe {
                        $($path_to_types)*:: _export_tune_cabi::<$ty > () } } #[unsafe
                        (export_name = "cabi_post_radio:station/station@0.1.0#tune")]
                        unsafe extern "C" fn _post_return_tune(arg0 : * mut u8,) { unsafe
                        { $($path_to_types)*:: __post_return_tune::<$ty > (arg0) } } };
                    };
                }
                #[doc(hidden)]
                pub(crate) use __export_radio_station_station_0_1_0_cabi;
                #[repr(align(8))]
                struct _RetArea(
                    [::core::mem::MaybeUninit<
                        u8,
...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_radio_station_impl {
    ($ty:ident) => {
        self::export!($ty with_types_in self);
    };
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::radio::station::station::__export_radio_station_station_0_1_0_cabi!($ty
        with_types_in $($path_to_types_root)*:: exports::radio::station::station);
    };
}
#[doc(inline)]
pub(crate) use __export_radio_station_impl as export;
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:radio:station@0.1.0:radio-station:encoded world"
)]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 6935] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\x935\x01A\x02\x01A\x1b\
...
ttp/outgoing-handler@0.2.3\x05\x0e\x01B\x05\x01r\x02\x07secondsw\x0bnanosecondsy\
\x04\0\x08datetime\x03\0\0\x01@\0\0\x01\x04\0\x03now\x01\x02\x04\0\x0aresolution\
\x01\x02\x03\0\x1cwasi:clocks/wall-clock@0.2.3\x05\x0f\x01B\x06\x01p}\x01k\0\x01\
@\x01\x03keys\0\x01\x04\0\x03get\x01\x02\x01@\x02\x03keys\x05value\0\x01\0\x04\0\
\x03set\x01\x03\x03\0\x1eradio:station/host-cache@0.1.0\x05\x10\x01B\x0b\x01ps\x01\
r\x07\x08callsigns\x04names\x0bdescriptions\x09frequencys\x08operators\x0fcadenc\
e-secondsy\x0edeclared-hosts\0\x04\0\x08metadata\x03\0\x01\x01r\x07\x02ids\x05ti\
tles\x04bodys\x06sources\x09permalinks\x09publishedw\x04tags\0\x04\0\x09broadcas\
t\x03\0\x03\x01q\x03\x06on-air\x01\x04\0\x06static\0\0\x07off-air\x01s\0\x04\0\x06\
signal\x03\0\x05\x01@\0\0\x02\x04\0\x08describe\x01\x07\x01@\0\0\x06\x04\0\x04tu\
ne\x01\x08\x04\0\x1bradio:station/station@0.1.0\x05\x11\x04\0!radio:station/radi\
o-station@0.1.0\x04\0\x0b\x13\x01\0\x0dradio-station\x03\0\0\0G\x09producers\x01\
