//! WEB3 — 108.3 MHz
//!
//! Ethereum ecosystem research and governance.
//! Sources: Vitalik's blog, Ethereum Foundation blog, Week in Ethereum.
...
impl Guest for Web3Station {
    fn describe() -> Metadata {
        Metadata {
            callsign:        "WEB3".to_string(),
            name:            "Web3".to_string(),
            description:     "Ethereum ecosystem — Vitalik, EF blog, Week in Ethereum.".to_string(),
            frequency:       "108.3".to_string(),
            operator:        "Pete".to_string(),
            cadence_seconds: 3600,
            declared_hosts:  vec![
                "vitalik.eth.limo".to_string(),
                "blog.ethereum.org".to_string(),
                "weekinethereumnews.com".to_string(),
            ],
        }
    }
...
bindings::export!(Web3Station with_types_in bindings);
